...
- `report` mode — list flagged users with ID, email, IP, and country code.
- `delete` mode — remove flagged users with interactive confirmation prompt.
- Custom country list via second argument (comma-separated, auto-normalised).
- Default blocked countries: RU, CN, IR, BY.
